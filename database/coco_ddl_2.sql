...
-- Table `coco`.`rank`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`rank` ;
...
-- Table `coco`.`member`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`member` ;
...
-- Table `coco`.`post`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`post` ;
...
-- Table `coco`.`follow`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`follow` ;
...
-- Table `coco`.`post_tag`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`post_tag` ;
...
-- Table `coco`.`comment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`comment` ;
...
-- Table `coco`.`mypage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`mypage` ;
...
-- Table `coco`.`like`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`like` ;
...
-- Table `coco`.`alarm`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`alarm` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`word_dictionary` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`baby_post` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`mypage_tag` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco`.`member_tag` ;
...
ALTER TABLE `coco`.`alarm` 
DROP FOREIGN KEY `fk_alarm_follow1`,
DROP FOREIGN KEY `fk_alarm_like1`,
DROP FOREIGN KEY `fk_alarm_post1`;
ALTER TABLE `coco`.`alarm` 
CHANGE COLUMN `post_id` `post_id` BIGINT(20) NULL ,
CHANGE COLUMN `like_id` `like_id` BIGINT(20) NULL ,
CHANGE COLUMN `follow_id` `follow_id` BIGINT(20) NULL ;
ALTER TABLE `coco`.`alarm` 
ADD CONSTRAINT `fk_alarm_follow1`
  FOREIGN KEY (`follow_id`)
  REFERENCES `coco`.`follow` (`idfollow`)
  ON DELETE CASCADE
  ON UPDATE CASCADE,
ADD CONSTRAINT `fk_alarm_like1`
  FOREIGN KEY (`like_id`)
  REFERENCES `coco`.`like` (`idlike`)
  ON DELETE CASCADE
  ON UPDATE CASCADE,
ADD CONSTRAINT `fk_alarm_post1`
  FOREIGN KEY (`post_id`)
  REFERENCES `coco`.`post` (`idpost`)
  ON DELETE CASCADE
  ON UPDATE CASCADE;
  
ALTER TABLE `coco`.`member_tag` 
ADD COLUMN `frequency` BIGINT NULL AFTER `access`;


ALTER TABLE `coco`.`mypage` 
ADD COLUMN `today_visited_count` BIGINT NULL AFTER `access`,
ADD COLUMN `total_visited_count` BIGINT NULL AFTER `today_visited_count`;
