...
public class Member {
	...
	public String toString() {
		return "Member [idmember=" + idmember + ", rankId=" + rankId + ", isManager=" + isManager + ", isDelete="
				...
				+ ", gitUrl=" + gitUrl + ", kakaoUrl=" + kakaoUrl + ", instargramUrl=" + instagramUrl
				+ ", dateCreated=" + dateCreated + ", updateCreated=" + updateCreated + ", grade=" + grade + "]";
	}
	...
	public void setInstargramUrl(String instargramUrl) {
		this.instagramUrl = instargramUrl;
	}
